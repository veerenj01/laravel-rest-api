...
#    git checkout 5.2
    ...
    php -r "
        ...
        \$arr[\"autoload\"][\"psr-4\"][\"veerenjp\\\\RestAPI\\\\\"] = \"laravel-rest-api/src\";
        \$arr[\"autoload\"][\"psr-4\"][\"veerenjp\\\\RestAPI\\\\Tests\\\\\"] = \"laravel-rest-api/tests\";
...
git clone https://github.com/veerenjp/laravel-rest-api-v2
git checkout main
composer du
cd .. || exit
